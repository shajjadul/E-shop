...
<head>
    ...
    <title>Infinity E-Commerce</title>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i>+918545005272</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> infinity99@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="logo pull-left">
							<center><a href="index.php"><img src="http://logosign.pw/wp-content/uploads/2015/10/Logo-e-commerce-english.jpg" alt="" class="img-responsive"/></a></center>
						</div>
